...
csv_config_dict = dict(
    ...
    futures_continuous_dir='data2/china_futures/continuous',
    futures_combined_dir='data2/china_futures/combined',
    futures_roll_calendar_dir='data2/china_futures/roll_calendar',
